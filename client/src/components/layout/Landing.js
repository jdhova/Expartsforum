            ...
            <div className="signup__container">
              <div className="container__child signup__thumbnail">
                <div className="thumbnail__logo">
                  ...
                  <h1 className="logo__text">Experts</h1>
                </div>
                <div className="thumbnail__content text-center">
                  <h1 className="heading--primary">Welcome</h1>
                  <h2 className="heading--secondary">Are you ready to join the experts?</h2>
                </div>
              ...
              {/* <div className="container__child signup__form"> */}
                {/* <form action="#">
                  <div className="form-group">
                    ...
                    <input className="form-control" type="text" name="username" id="username" placeholder="your name" required />
                  </div>
                  <div className="form-group">
